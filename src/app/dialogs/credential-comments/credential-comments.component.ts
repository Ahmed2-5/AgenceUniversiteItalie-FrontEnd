...
import { CommentaireCredential } from 'src/app/models/CommentaireCredential.model';
import { Utilisateur } from 'src/app/models/Utilisateur.model';
import { AuthService } from 'src/app/services/auth.service';
import { UserService } from 'src/app/services/user.service';
import { Credential } from 'src/app/models/Credential.model';
import { MAT_DIALOG_DATA, MatDialogRef } from '@angular/material/dialog';
import { CommentaireCredentialService } from 'src/app/services/commentaire-credential.service';

@Component({
  selector: 'app-credential-comments',
  templateUrl: './credential-comments.component.html',
  styleUrls: ['./credential-comments.component.scss']
})
export class CredentialCommentsComponent implements OnInit {

  comments: CommentaireCredential[] = [];
    forminput!: FormGroup;
    ...
    constructor(
      ...
      @Inject(MAT_DIALOG_DATA) public data: { credentialID: number },
      private dialogRef: MatDialogRef<CredentialCommentsComponent>, 
      private commentserv: CommentaireCredentialService
    ) {}
    ...
    loadComments(): void {
      this.commentserv.GetCommentsByCredential(this.data.credentialID).subscribe((comments) => {
        ...
        this.commentDates = new Set<Date>(comments.map(comment => new Date(comment.dateCreationCommentaireCredential)));
      });
    }
    ...
    sendComment(): void {
      ...
      this.commentserv.addComment(this.data.credentialID,contenu, this.user.adresseMail).subscribe((d) => {
        this.loadComments(); 
